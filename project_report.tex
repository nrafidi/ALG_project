...
\section{Results}
\section{Conclusion}
It is clear from the results that while stochastic gradient descent seems at first glance to be an essentially sequential algorithm, parallelization leads to significant improvements in runtime without any significant convergence cost. As the number of features and the number of samples increases, the benefits of parallelizing the algorithm become more apparent.
